  ...
  return (
    <div >
        ...
        <div className='flex bg-richblack-800 p-1 gap-x-1 my-6 rounded-full max-w-max'>
            ...
            :"bg-transparent bg-richblack-200"} py-2  px-5 rounded-full transition-all duration-200`}
        ...
        <button className='w-full bg-yellow-50 rounded-md font-medium text-richblack-900 px-[12px] py-[8px] mt-6 '>
            Create Account
        </button>
        </form>
